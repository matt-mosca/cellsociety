...
public class GraphSegregation {
	...
	public GraphSegregation(SimulationSegregation s, ResourceBundle rb) {
	...
	private void updateLine(XYChart.Series<Number, Number> line) {
		...
		else if(line.getName().equals(resources.getString("bluename"))) {
